...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Prepare and bind for certholders table
    $stmt1 = $conn->prepare("INSERT INTO certholders (
    ...
    if ($stmt1->execute()) {
        echo "Certificate holder's data inserted successfully.<br>";
    } else {
        echo "Error inserting into certholders table: " . $stmt1->error;
    }
